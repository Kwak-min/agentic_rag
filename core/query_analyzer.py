...
class QueryAnalyzer:
    ...
    def _rule_based_analysis(self, query):
        ...
        rule_patterns = {
            ...
            "점검_로그_검색": {
                "keywords": [
                    "점검 로그", "점검 이력", "최근 점검", "이전 점검", "저번 점검",
                    "점검 기록", "점검 내역", "검사 이력", "과거 점검", "점검 조회",
                    "점검해줘", "점검 찾아", "로그 요약", "점검 요약", "점검했",
                    "문제 이력", "고장 이력", "수리 이력", "조치 이력"
                ],
                "tools": [{"name": "search_inspection_logs", "arguments": {}}]
            }
        }
